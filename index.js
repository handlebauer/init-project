...
const { defaultGitignore } = require('./src/default-gitignore.js')
const { defaultRollupConfig } = require('./src/default-rollup-config.js')
const { defaultTest } = require('./src/default-test.js')
